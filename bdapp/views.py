...
def histogram_view(request):
    ...
    #plt.savefig('bdapp/static/bdapp/histogram.png')
...
def pie_chart_view(request):
    ...
    explode = [0.1] * len(df['subject_name'])  # Выделение секторов для лучшей видимости
    colors = plt.cm.Set3.colors  # Использование цветовой схемы Set3 для разнообразия цветов
    ...
    # plt.savefig('bdapp/static/bdapp/pie_chart.png')
...
def score_range_histogram_view(request):
    ...
    #plt.savefig('bdapp/static/bdapp/score_range_histogram.png')
